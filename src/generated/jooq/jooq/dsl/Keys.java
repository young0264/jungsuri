...
import jooq.dsl.tables.records.FlywaySchemaHistoryRecord;
...
public class Keys {
    ...
    public static final UniqueKey<AccountTagRecord> KEY_ACCOUNT_TAG_PRIMARY = Internal.createUniqueKey(AccountTag.ACCOUNT_TAG, DSL.name("KEY_account_tag_PRIMARY"), new TableField[] { AccountTag.ACCOUNT_TAG.ACCOUNT_TAG_ID }, true);
    ...
    public static final UniqueKey<MountainTagRecord> KEY_MOUNTAIN_TAG_PRIMARY = Internal.createUniqueKey(MountainTag.MOUNTAIN_TAG, DSL.name("KEY_mountain_tag_PRIMARY"), new TableField[] { MountainTag.MOUNTAIN_TAG.MOUNTAIN_TAG_ID }, true);
    ...
    public static final UniqueKey<PostTagRecord> KEY_POST_TAG_PRIMARY = Internal.createUniqueKey(PostTag.POST_TAG, DSL.name("KEY_post_tag_PRIMARY"), new TableField[] { PostTag.POST_TAG.POST_TAG_ID }, true);
    ...
    public static final ForeignKey<PostTagRecord, TagRecord> FK71DNM74267JIV0XXU0MWR3GHM = Internal.createForeignKey(PostTag.POST_TAG, DSL.name("FK71dnm74267jiv0xxu0mwr3ghm"), new TableField[] { PostTag.POST_TAG.POST_TAG_ID }, Keys.KEY_TAG_PRIMARY, new TableField[] { Tag.TAG.ID }, true);
