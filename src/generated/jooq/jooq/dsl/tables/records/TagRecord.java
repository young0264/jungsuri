...
public class TagRecord extends UpdatableRecordImpl<TagRecord> implements Record4<Integer, LocalDateTime, Long, String> {
    ...
    @Override
    public Row4<Integer, LocalDateTime, Long, String> valuesRow() {
    ...
    @Override
    public TagRecord values(Integer value1, LocalDateTime value2, Long value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TagRecord(Integer usedCount, LocalDateTime createdAt, Long id, String name) {
        super(Tag.TAG);
