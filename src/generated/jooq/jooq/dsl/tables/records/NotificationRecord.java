...
public class NotificationRecord extends UpdatableRecordImpl<NotificationRecord> implements Record7<Boolean, Long, LocalDateTime, Long, String, String, NotificationType> {
    ...
    @Override
    public Row7<Boolean, Long, LocalDateTime, Long, String, String, NotificationType> valuesRow() {
    ...
    @Override
    public NotificationRecord values(Boolean value1, Long value2, LocalDateTime value3, Long value4, String value5, String value6, NotificationType value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NotificationRecord(Boolean checked, Long accountEntityId, LocalDateTime createdAt, Long id, String message, String title, NotificationType type) {
        super(Notification.NOTIFICATION);
